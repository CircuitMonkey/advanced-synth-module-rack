/*
    ...
    --Pin assignments---
      ...
      (removed) BUTTON   GPIO6    change octave 0,+1,+2,+3
...
HagiwoLFO *HagiwoLFO::isrTable[SOC_TIMER_GROUP_TOTAL_TIMERS];

/* -----------------------------------------------------------------------
 *  PolyBLEP helper  (returns discontinuity correction)
 * -------------------------------------------------------------------- */
inline float HagiwoLFO::polyBLEP(float t, float dt) {
 ...
 * ==================================================================== */
void __isr HagiwoLFO::onPwmWrap() {
  ...
  // Illuminate LED based on PWM value
  analogWrite(5, (int)(pwmSample) >> 2);
...
void HagiwoLFO::begin() {
 ...
 const uint8_t timerNumber = 0;
  ...
  //irq_set_exclusive_handler(PWM_IRQ_WRAP, HagiwoLFO::onPwmWrap);
